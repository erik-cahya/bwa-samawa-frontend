...
function WeddingPackageSlider({ data }: { data: TPackage[] }) {
    return <div className='relative'>
        <Slider>
            <div className="card-slide h-full rounded-3xl overflow-hidden relative">
                <figure className="w-full h-full absolute">
                    <img className="w-full h-full object-cover object-center" src="/images/image 1.png"
                ...
                <div className="card-slide-content flex flex-col items-start gap-y-5">
                    ...
                    <span className="flex flex-col gap-y-1">
                        ...
                        <span className="text-xl text-color2 font-semibold">Rp 198.493.000</span>
                    </span>
                    <span className="flex gap-x-4">
                        <span className="flex gap-x-2 items-center">
                            <svg className="text-color1" width="21" height="21" viewBox="0 0 21 21" fill="none"
                        ...
                        <span className="flex gap-x-2 items-center">
                            <svg className="text-color1" width="21" height="21" viewBox="0 0 21 21" fill="none"
                                ...
                                <path
                                    ...
                                    className="fill-current" />
                                <path d="M13.0083 12.7917H3.00834L3 11.5417H13L13.0083 12.7917Z" className="fill-current" />
                                <path
                    ...
                    <a href="/wedding-details.html"
                        className="flex justify-center bg-color2 py-2 w-full text-light1 rounded-full">View Package</a>
                </div>
            </div>
        </Slider>
    </div>;
...
async function PropsWeddingPakcageWrapper({ show, type }: PropsWeddingPakcageWrapper) {
